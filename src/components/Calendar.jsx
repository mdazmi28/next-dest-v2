...
//             );
//             eventDates.push({ days: daysInRange, appointment_subject: event.appointment_subject });
//         });
//         return eventDates;
//     };
...
//             .map((event) => event.appointment_subject);
...
//                 // <div
//                 //     key={formattedDate}
//                 //     className={`p-2 cursor-pointer ${priority === "normal"
...
//                             <ul>
//                                 {selectedEvents.map((appointment_subject, index) => (
//                                     <li key={index} className="bg-blue-200 p-2 rounded mb-2 flex justify-center">
//                                         {appointment_subject}
//                                     </li>
//                                 ))}
//                             </ul>
...
//         return daysInMonth.map((date) => {
//             const formattedDate = format(date, "dd-MM-yyyy");
//             const eventForDate = eventDates.find(
//                 (event) => event.day === formattedDate
//             );
...
//             const bgColor = eventForDate
//                 ? priorityColors[eventForDate.priority] || "bg-gray-200"
//                 : "bg-gray-200";

//             return (
//                 <div
//                     key={formattedDate}
//                     className={`p-2 cursor-pointer ${bgColor} `}
//                     onClick={() => handleDateClick(formattedDate)}
//                 >
//                     {format(date, "d")}
//                 </div>
...
//                                     <li
//                                         key={index}
//                                         className="bg-blue-200 p-2 rounded mb-2 flex justify-center"
//                                     >
//                                         {appointment_subject}
//                                     </li>
//                                 ))}
//                             </ul>
//                         ) : (
//                             <div className="bg-yellow-200 p-2 rounded mb-2 flex justify-center">
