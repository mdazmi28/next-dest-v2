...
const Table = ({ contactData, setContactData }) => {
    ...
    //                 `${base_url}/users/${userId}/contacts/${selectedContactId}/`,
    //                 {
    //                     method: "PUT",
    //                     headers: {
    ...
    //             if (response.ok) {
    //                 const updatedContact = await response.json(); // Fetch updated contact data
    //                 setContactData((prevContacts) =>
    //                     prevContacts.map((contact) =>
    //                         contact.id === selectedContactId ? updatedContact : contact
    //                     )
    //                 );
    ...
    //     setContactData((prevContacts) =>
    //         prevContacts.map((contact) =>
    //             contact.id === id ? { ...contact, ...requestBody } : contact
    //         )
    //     );
    ...
    //     // ✅ Step 2: Force React to re-render by updating state
    //     setContactData((prev) => [...prev]);

    //     // ✅ Step 3: Close modal immediately for better UX
    //     setIsEditOpen(false);
                ...
                {/* {isEditOpen && editData && Object.keys(editData).length > 0 && (
                    <div className="modal modal-open">
                        <div className="modal-box">
                            ...
                            <div className="modal-action">
                                <button className="btn btn-primary" onClick={() => saveEdit(editData.contact_id)}>
